...
A linear regression model with intercept $\beta_{0} = 0$ is under consideration. Data have been obtained that contain replications. State the full and reduced models for testing the appropriateness of the regression function under consideration. What are the degress of freedom associated with the full and reduced model if n = 20 and c= 10?
